                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('nama_pegawai'); ?>" name="nama_pegawai" id="nama_pegawai" type="text" class="form-control" placeholder="Nama Pegawai...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('no_telp_pegawai'); ?>" name="no_telp_pegawai" id="no_telp_pegawai" type="text" class="form-control" placeholder="Nomor Telepon...">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <textarea name="alamat_pegawai" id="alamat_pegawai" class="form-control" rows="4" placeholder="Alamat..."><?= set_value('alamat_pegawai'); ?></textarea>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <textarea name="posisi_pegawai" id="posisi_pegawai" class="form-control" rows="4" placeholder="Posisi..."><?= set_value('posisi_pegawai'); ?></textarea>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <textarea name="gaji_pegawai" id="gaji_pegawai" class="form-control" rows="4" placeholder="Gaji..."><?= set_value('gaji_pegawai'); ?></textarea>
                        </div>
