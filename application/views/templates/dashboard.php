...
<head>
    ...
    <title><?= $title; ?> | Kedelai Manufacturing</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Kedelai Manufacturing</div>
            </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Inventory & Kedelai Manufacturing 2021 &bull; by <?= anchor('https://github.com/hattafaiq', 'Daichi Tech'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <?php if ($this->uri->segment(1) == 'dashboard') : ?>
        ...
        <script type="text/javascript">
            ...
            Chart.defaults.global.defaultFontColor = '#DC143C';
